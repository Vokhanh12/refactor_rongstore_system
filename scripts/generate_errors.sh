...
OUTPUT_FILE="../internal/$svc/errors/errors_gen.go"
...
echo "" >> "$OUTPUT_FILE"
echo "import \"server/pkg/apperrors\"" >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"
...
{
echo -e "\t${const_name} = errors.AppErrorDetail{"
echo -e "\t\tCode: \"$code\","
echo -e "\t\tMessage: \"$message\","
echo -e "\t}"
echo ""
...
echo "var ErrorDetailByCode = map[string]errors.AppErrorDetail{" >> "$OUTPUT_FILE"
...
OUTPUT_DEFAULT_FILE="../pkg/errors/errors_gen.go"
