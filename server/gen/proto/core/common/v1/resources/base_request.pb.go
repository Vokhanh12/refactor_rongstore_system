...
type BaseRequest struct {
	...
	RequestDateTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=request_date_time,json=requestDateTime,proto3" json:"request_date_time,omitempty"`
...
func (x *BaseRequest) GetRequestDateTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_core_common_v1_resources_base_request_proto_rawDesc = "" +
	"\n" +
	"+core/common/v1/resources/base_request.proto\x12\tcommon.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcb\x01\n" +
	"\vBaseRequest\x12F\n" +
	"\x11request_date_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x0frequestDateTime\x12'\n" +
	"\n" +
	...
	"\n" +
	"user_agent\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tuserAgentBYZWgithub.com/vokhanh12/refactor-rongstore-system/server/gen/proto/core/common/v1;commonv1b\x06proto3"
...
var file_core_common_v1_resources_base_request_proto_depIdxs = []int32{
	1, // 0: common.v1.BaseRequest.request_date_time:type_name -> google.protobuf.Timestamp
