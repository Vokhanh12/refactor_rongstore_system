...
type Error struct {
	...
	ClientAction  string                 `protobuf:"bytes,9,opt,name=client_action,json=clientAction,proto3" json:"client_action,omitempty"`
	ServerAction  string                 `protobuf:"bytes,10,opt,name=server_action,json=serverAction,proto3" json:"server_action,omitempty"`
	Details       []*ErrorDetail         `protobuf:"bytes,11,rep,name=details,proto3" json:"details,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Error) GetClientAction() string {
	if x != nil {
...
func (x *Error) GetServerAction() string {
	if x != nil {
...
const file_common_v1_error_proto_rawDesc = "" +
	...
	"httpStatus\x12#\n" +
	"\rclient_action\x18\t \x01(\tR\fclientAction\x12#\n" +
	"\rserver_action\x18\n" +
	" \x01(\tR\fserverAction\x120\n" +
	"\adetails\x18\v \x03(\v2\x16.common.v1.ErrorDetailR\adetailsBTZRgithub.com/vokhanh12/refactor-rongstore-system/server/gen/proto/common/v1;commonv1b\x06proto3"
