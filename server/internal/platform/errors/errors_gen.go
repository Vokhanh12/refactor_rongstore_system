...
var (
	...
	DB_CONFLICT = apperrors.AppError{
		...
		ClientMessage: "The request conflicts with existing data",
		Severity:      "S3",
		Retryable:     false,
		Cause:         "",
	}
	...
	DB_INVALID_REFERENCE = apperrors.AppError{
		...
		ClientMessage: "The requested data is invalid",
		Severity:      "S3",
		Retryable:     false,
		Cause:         "",
	}
	...
	DB_QUERY_CANCELED = apperrors.AppError{
		...
		ClientMessage: "The request was canceled",
		Severity:      "S2",
		Retryable:     false,
		Cause:         "",
	}
	...
	DB_SERIALIZATION_CONFLICT = apperrors.AppError{
		...
		ClientMessage: "The request could not be completed. Please try again",
		Severity:      "S2",
		Retryable:     true,
		Cause:         "",
	}
