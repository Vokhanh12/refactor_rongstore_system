...
var (
	DOM_NONE = apperrors.AppError{
		...
		ClientMessage: "Invalid authorization",
		Severity:      "S3",
		Retryable:     false,
		Cause:         "",
	}
	...
	RESOURCE_OR_ACTION_REQUIRED = apperrors.AppError{
		...
		ClientMessage: "Resource and action are required",
		Severity:      "S3",
		Retryable:     false,
		Cause:         "",
	}
	...
	ROLE_REQUIRED = apperrors.AppError{
		...
		ClientMessage: "Role is required",
		Severity:      "S3",
		Retryable:     false,
		Cause:         "",
	}
...
var ErrorByCode = map[string]apperrors.AppError{
	...
	"AUTHZ-TRANSPORT-001": AUTHORIZATION_INVALID,
	"AUTHZ-TRANSPORT-002": RESOURCE_OR_ACTION_REQUIRED,
	"AUTHZ-TRANSPORT-003": ROLE_REQUIRED,
