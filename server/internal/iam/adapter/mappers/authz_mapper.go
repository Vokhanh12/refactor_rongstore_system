...
type authzMapper interface {
	// proto - command
	RolePermissionMutateProtoToCommand(req *authzrs.RolePermissionMutateRequest) authzuc.RolePermissionMutationBatch
	RoleMutateProtoToCommand(req *authzrs.RoleMutateRequest) authzuc.RoleMutationBatch
	PermissionMutateProtoToCommand(req *authzrs.PermissionMutateRequest) authzuc.PermissionMutationBatch

	RolePermissionViewProtoToCommand(req *authzrs.RolePermissionViewRequest) authzuc.RolePermissionViewBatch
	RoleViewProtoToCommand(req *authzrs.RoleViewRequest) authzuc.RoleViewBatch
	PermissionViewProtoToCommand(req *authzrs.PermissionViewRequest) authzuc.PermissionViewBatch

	// entity - db
	roleScopeTypeFromDB(t db.RoleScopeType) enu.RoleScopeType
	roleAccessScopeToDB(t enu.RoleAccessScope) db.RoleAccessScope
	CreateRoleToDBParams(role *entities.Role) db.CreateRoleParams
	// db - entity
	CreateRoleDBToRoleEntity(row db.CreateRoleRow) entities.Role
}
